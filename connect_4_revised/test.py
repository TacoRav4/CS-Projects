...
parser = argparse.ArgumentParser(description='Run Connect 4 tests with various configurations.')
parser.add_argument('-print_time_logs', type=bool, default=True, 
                    help='Whether to print time logs for each move')
